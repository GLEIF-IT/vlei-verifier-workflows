...
import { buildCredentials, CredentialInfo, IdentifierData } from "./utils/handle-json-config";
...
export class WorkflowState {
    ...
    static getInstance(configJson: any = null): WorkflowState {
        if (!WorkflowState.instance) {
            if (!configJson) throw ("WorkflowState.getInstance: no configJson was provided");
