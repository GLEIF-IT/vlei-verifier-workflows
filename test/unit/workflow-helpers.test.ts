import { loadPackagedWorkflow, listPackagedWorkflows } from '../../src/utils/workflow-helpers';
...
describe('workflow-helpers', () => {
  describe('loadPackagedWorkflow', () => {
    ...
    it('should throw error for non-existent workflow', () => {
      ...
      expect(() => loadPackagedWorkflow('non-existent-workflow'))
        .toThrow('Could not find workflow file: non-existent-workflow.yaml');
    });
    ...
    it('should throw error for invalid workflow file', () => {
      ...
      try {
        expect(() => loadPackagedWorkflow('invalid'))
          .toThrow(/Failed to load workflow file/);
      } finally {
        // Clean up temp file
